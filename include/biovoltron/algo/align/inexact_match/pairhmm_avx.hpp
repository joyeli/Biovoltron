...
struct AvxPairHMM {
 ...
 private:
  ...
  auto
  getData(const std::vector<SamRecord<>>& readDataArray,
          const std::vector<Haplotype>& haplotypeDataArray)
    -> std::vector<std::vector<testcase>>;

  auto
  initNative(bool use_double = false, int max_threads = 64) -> void;

  auto
  computeLikelihoodsNative(const std::vector<SamRecord<>>& readDataArray,
                           const std::vector<Haplotype>& haplotypeDataArray,
...
auto
AvxPairHMM::initNative(bool use_double, int max_threads) -> void {
  SPDLOG_DEBUG("Enter");
...
auto
AvxPairHMM::computeLikelihoodsNative(
  const std::vector<SamRecord<>>& readDataArray,
  const std::vector<Haplotype>& haplotypeDataArray,
  std::vector<std::vector<double>>& likelihoodArray) -> void {
  SPDLOG_DEBUG("Enter");
...
auto
AvxPairHMM::getData(const std::vector<SamRecord<>>& readDataArray,
                    const std::vector<Haplotype>& haplotypeDataArray)
  -> std::vector<std::vector<testcase>> {
